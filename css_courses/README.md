...
###
1:02:40
shift+alt+down for copy elements
shift+alt+A for comment css
ctrl+b remove file manager
ctrl+b select both ele
margin collapsing
for unicode-https://symbl.cc/en/
https://specificity.keegan.st/
chapter 13 revise
https://flexboxfroggy.com/ - flex challenge
https://cssgridgarden.com/ - grid challenge